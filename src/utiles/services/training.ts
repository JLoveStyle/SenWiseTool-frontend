...
export const db_update_training = async (data: DBTrainingProps, id: string) => {
  ...
  return mutateUpApiData<ApiDataResponse<TrainingType>>(Route.training, data, id)
    .then((response) => {
...
export const db_get_trainings = async (companyId?: string) => {
  ...
  return await fetchApiData<ApiDataResponse<TrainingType[] | TrainingType>>(Route.training, companyId)
    .then((response) => {
