...
export default function AgricultureDetails({ params: { id } }: TProps) {
  ...
  return (
    <LayoutDashboardTemplate title="Agriculture - Détails de l'activité N°{id}">
